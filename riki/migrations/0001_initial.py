# Generated by Django 2.0.6 on 2018-12-12 08:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('paper', 'Paper'), ('review', 'Review'), ('presentation', 'Presentation'), ('data', 'Data'), ('publication', 'Publication'), ('code', 'Code'), ('competition', 'Competition'), ('confpaper', 'Conference Paper')], default='paper', max_length=40)),
            ],
        ),
        migrations.CreateModel(
            name='Work',
