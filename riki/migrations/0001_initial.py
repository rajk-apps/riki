    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='riki.Work')),
            ],
        ),
        migrations.CreateModel(
            name='UserSemester',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specially_closed_for_person', models.ManyToManyField(blank=True, related_name='outcast', to=settings.AUTH_USER_MODEL)),
                ('specially_open', models.ManyToManyField(blank=True, to='riki.Course')),
                ('specially_open_for_person', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
